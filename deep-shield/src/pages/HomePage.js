        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <button
              ...
              className="bg-blue-600 text-white p-4 rounded-xl font-bold hover:bg-blue-900 shadow-lg"
            >
              Encrypt
            </button>
            ...
            <button
              ...
              className="col-span-2 bg-blue-600 text-white p-3 rounded-xl font-semibold hover:bg-blue-900"
            >
              View Activity
            </button>
          </div>
